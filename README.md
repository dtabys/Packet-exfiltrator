...
Packet Exfiltrator sends desired message by crafting either a ICMP Echo Request Message or TCP SYN packet (to port 80), and sending it to the specified IP using a given interface.
